...
describe('Add comma to int', function() {
  var formatInt = require('../int2str.js').formatInt;
  describe('#formatInt()', function() {
    it ('formatInt should convert int to str and add comma', function() {
      formatInt(0).should.equal('0');
      formatInt(000).should.equal('0');
      formatInt(099).should.equal('99');
      formatInt(1000).should.equal('1,000');
      formatInt(1000123).should.equal('1,000,123');
    });
  })
})
